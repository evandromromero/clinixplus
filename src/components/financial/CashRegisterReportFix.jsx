...
/**
 * Função para gerar o HTML do relatório de caixa com layout corrigido
 * Esta função substitui a função generateReportHtml original
 */
export const generateReportHtml = (cashData, transactions, paymentMethods, formatDate, formatTime, getPaymentMethodTotals, formatPaymentMethodsForReport, ptBR, normalizeDate, parseISO, format) => {
